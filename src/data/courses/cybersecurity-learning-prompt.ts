...
export const cybersecurityLearningPromptCourse: CourseDocument = {
  id: "cybersecurity-learning-prompt",
  slug: "cybersecurity-learning-prompt",
  title: "Cybersecurity Learning Prompt",
  description:
    "An interactive cybersecurity learning prompt covering foundations, offensive and defensive practice, GRC, cloud, tools, and exercises.",
  content: String.raw`# Cybersecurity Learning Prompt
