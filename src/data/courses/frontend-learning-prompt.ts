...
export const frontendLearningPromptCourse: CourseDocument = {
  id: "frontend-learning-prompt",
  slug: "frontend-learning-prompt",
  title: "Frontend Development Learning Prompt",
  description:
    "An interactive frontend development learning prompt covering theory, exercises, solutions, and a structured curriculum from basics to advanced practice.",
  content: String.raw`# Frontend Development — Interactive Learning Prompt
