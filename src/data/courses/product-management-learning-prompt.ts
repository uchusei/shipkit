...
export const productManagementLearningPromptCourse: CourseDocument = {
  id: "product-management-learning-prompt",
  slug: "product-management-learning-prompt",
  title: "Product Management Learning Prompt",
  description:
    "An interactive product management and product owner learning prompt with curriculum navigation, exercises, and feedback loops.",
  content: String.raw`# Product Management & Product Owner — Learning Prompt
